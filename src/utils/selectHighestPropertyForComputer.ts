...
export const selectHighestPropertyForComputer = (computerCard: Card) => {
  ...
  // Überprüfen, ob alle Eigenschaften kleiner als 4 sind
  const areAllPropertiesLessThan4 = ['eigenschaft1', 'eigenschaft2', 'eigenschaft3', 'eigenschaft4', 'eigenschaft5'].every(
  ...
  if (areAllPropertiesLessThan4) {
    ...
    ['eigenschaft1', 'eigenschaft2', 'eigenschaft3', 'eigenschaft4', 'eigenschaft5'].forEach((prop) => {
